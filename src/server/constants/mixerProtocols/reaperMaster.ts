	...
	channelTypes: [
		{
			...
			fromMixer: {
				...
				CHANNEL_VU: [
					{ mixerMessage: '/track/{channel}/vu', value: 0, type: 'f', min: 0, max: 1, zero: 0.75 }
				],
				CHANNEL_VU_REDUCTION: [emptyMixerMessage()],
				CHANNEL_NAME: [
					{ mixerMessage: '/track/{channel}/name', value: 0, type: 'f', min: 0, max: 1, zero: 0.75 }
				],
		...
		},
		{
			...
			fromMixer: {
				CHANNEL_OUT_GAIN: [
					{ mixerMessage: '/master/volume', value: 0, type: 'f', min: 0, max: 1, zero: 0.75 }
				],
				CHANNEL_VU: [
