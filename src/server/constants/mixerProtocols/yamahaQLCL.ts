	...
	channelTypes: [
		{
			...
			fromMixer: {
				CHANNEL_OUT_GAIN: [
					{
						mixerMessage: 'f0 43 10 3e 19 01 00 37 00 00 {channel} 00 00 00 {level} f7',
						value: 0,
						type: '',
						min: 0,
						max: 1,
				...
				CHANNEL_MUTE_ON: [
					{
						mixerMessage: 'f0 43 10 3e 19 01 00 35 00 00 {channel} 00 00 00 00 00 f7',
						value: 0,
						type: '',
						min: 0,
						max: 1,
			...
			toMixer: {
				...
				CHANNEL_MUTE_OFF: [
					{
						mixerMessage: 'f0 43 10 3e 19 01 00 35 00 00 {channel} 00 00 00 00 01 f7',
						value: 0,
						type: '',
						min: 0,
						max: 1,
